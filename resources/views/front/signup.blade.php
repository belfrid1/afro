    ...
    <div id="wrapper">
        ...
        <div class="container mt-3 mb-3">
            <div class="well-filters">
                <h1>Time-lapse video shows off Sacramento&#039;s beauty at night</h1>
            </div>
            <div class="row">
                <div class="content-left mt-3 mb-3">
                    <div class="video-container"> <video id="video"
                                                         class="video-js vjs-16-9 vjs-big-play-centered vjs-sublime-skin" preload="auto"
                                                         controls="true" playsinline webkit-playsinline
                                                         poster="../../media/videos/tmb/19/default.jpg" data-setup='{
		  "autoplay": false,
		  "plugins": {
		  "vastClient": {
			...
			"adsEnabled": true			}
                            ...
                            <source
                                src="https://video.clipsharelive.com:/streaming/-iftgkyJcnPNALA7Hxp0xg/1664575839/19_720p.mp4"
                                type='video/mp4' label='720p' res='720' />
                            <source
                                src="https://video.clipsharelive.com:/streaming/mk8HpSeHHntlCIKCX_q1sA/1664575839/19_480p.mp4"
                                type='video/mp4' label='480p' res='480' />
                            <source
                                src="https://video.clipsharelive.com:/streaming/hCmEcA00Zxd8rRKufb8v-g/1664575839/19_360p.mp4"
                                type='video/mp4' label='360p' res='360' />
                            <source
                                src="https://video.clipsharelive.com:/streaming/OJM6K8oxdBUA7d9wMkBaDg/1664575839/19_240p.mp4"
                    ...
                    <div class="comments-section mt-3">
                        ...
                        <div class="well-filters mb-1">
                            ...
                            <div class="float-left">
                                <h1> <a id="comments_sort" href="#" data-id="19" data-type="video" data-sort="newest"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                            class="fas fa-sort-amount-down"></i></a>
                                    <div class="dropdown-menu dropdown-menu-left" aria-labelledby="comments_sort"> <a
                                            class="dropdown-item active" data-sort="newest" id="comments_sort_newest"
                                            href="#">
                                            Newest
                            ...
                            <div class="float-left ml-3">
                                <h1> <span id="sort_loading"></span> </h1>
                            </div>
                            <div class="float-right">
                                <h1><span id="comments_total">4</span></h1>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div id="comments_input_container"> <textarea data-id="19" data-type="video" id="comments_input"
                                                                      rows="3" maxlength="1000" class="form-control" disabled></textarea> <span
                                id="comments_login_register" class="">Please <a id="comments_login" data-toggle="modal"
                                                                                href="#login-modal">log in</a> or <a id="comments_register"
                                                                                                                     href="../../signup.html">register</a> to post comments</span> </div>
                        <div id="comments_list" class="comments-list">
                            <div class="comment-item" id="comment_132">
                                <div class="comment-user"> <a href="../../user/mrwaveweed.html"> <img
                                            src="../../media/users/128548.jpg" alt="mrwaveweed"> </a> </div>
                                <div class="comment-info">
                                    <div class="comment-body">
                                        <div class="comment-actions"> <a id="comment_actions_video_132"
                                                                         data-uid="128548" data-rel="video_132" href="#" data-toggle="dropdown"
                                                                         aria-haspopup="true" aria-expanded="false"> <i
                                                    class="fas fa-ellipsis-h"></i> </a>
                                            <div class="dropdown-menu dropdown-menu-right"
                                                 aria-labelledby="comment_actions_video_132"> <a class="dropdown-item "
                                                                                                 id="report_comment_video_132" href="#"> <i class="fas fa-flag"></i>
                                                    Report Spam
                                                </a> <a class="dropdown-item d-none" id="delete_comment_video_132"
                                                        href="#"> <i class="fas fa-trash"></i> Delete
                                                </a> </div>
                                        </div>
                                        <div class="comment-user-info"> <a class="comment-username"
                                                                           href="../../user/mrwaveweed.html">mrwaveweed</a> <span
                                                class="comment-add-time"><i class="far fa-clock"></i>3 months ago</span>
                                        </div>
                                        <div class="comment-text">
                                            Are you depressed, suffering from cancer, glaucoma, headache, insomnia,
                                            joint pains, multiple sclerosis, muscle cramps &amp; need the best weed
                                            strains of medical &amp; recreational marijuana products to help you ? You
                                            are at the right spot with Just a click below, order top quality products,
                                            track it and relax. It will arrive you soonest as we offer discreet &amp;
                                            fast deliveries.<br /> <br /> <br />
                                            MR WAVE WEED SHOP <br /> <br /> <br />
                                            Herbal Incense USA <br /> <br /> <br />
                                            Best Weed Strains <br /> <br /> <br />
                                            K2 Spice Liquid on Paper <br /> <br /> <br />
                                            Buy Lemon Cherry Gelato Strain <br /> <br /> <br />
                                            Buy Weed Online <br /> <br /> <br />
                                            Pink SuperFly Gumbo Strain
                                        </div>
                                        <div class="comment-meta">
                                            <div class="vote-box"> <span class="content-rating"> <span
                                                        class="vote-up mr-1"><i id="comment_vote_up_video_132"
                                                                                class="fas fa-thumbs-up"></i><span
                                                            id="comment_rate_video_132">0</span></span> <span
                                                        class="vote-down"><i id="comment_vote_down_video_132"
                                                                             class="fas fa-thumbs-down"></i></span> </span> </div>
                                            <div class="comment-reply"> <a id="comment_reply_video_132" data-id="132"
                                                                           data-type="video" data-reply-username="" class="" href="#"><i
                                                        class="fas fa-share"></i>Reply</a> </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="comment-replies">
                                    <div class="comment-reply-container d-none" id="reply_container_video_132"></div>
                                    <div class="comments-list replies-list" id="replies_more_video_132"></div>
                                    <div class="comments-list replies-list" id="replies_list_video_132"></div>
                                </div>
                            </div>
                            <div class="comment-item" id="comment_123">
                                <div class="comment-user"> <a href="../../user/demo.html"> <img
                                            src="../../media/users/18776.jpg" alt="demo"> </a> </div>
                                <div class="comment-info">
                                    <div class="comment-body">
                                        <div class="comment-actions"> <a id="comment_actions_video_123" data-uid="18776"
                                                                         data-rel="video_123" href="#" data-toggle="dropdown"
                                                                         aria-haspopup="true" aria-expanded="false"> <i
                                                    class="fas fa-ellipsis-h"></i> </a>
                                            <div class="dropdown-menu dropdown-menu-right"
                                                 aria-labelledby="comment_actions_video_123"> <a class="dropdown-item "
                                                                                                 id="report_comment_video_123" href="#"> <i class="fas fa-flag"></i>
                                                    Report Spam
                                                </a> <a class="dropdown-item d-none" id="delete_comment_video_123"
                                                        href="#"> <i class="fas fa-trash"></i> Delete
                                                </a> </div>
                                        </div>
                                        <div class="comment-user-info"> <a class="comment-username"
                                                                           href="../../user/demo.html">demo</a> <span class="comment-add-time"><i
                                                    class="far fa-clock"></i>6 months ago</span> </div>
                                        <div class="comment-text">
                                            <div class="row justify-content-center">
                                                <div class="col-md-6">
                                                    <div><iframe src="../../view9787.html?VID=9753" frameborder="0"
                                        ...
                                        <div class="comment-meta">
                                            <div class="vote-box"> <span class="content-rating"> <span
                                                        class="vote-up mr-1"><i id="comment_vote_up_video_123"
                                                                                class="fas fa-thumbs-up"></i><span
                                                            id="comment_rate_video_123">0</span></span> <span
                                                        class="vote-down"><i id="comment_vote_down_video_123"
                                                                             class="fas fa-thumbs-down"></i></span> </span> </div>
                                            <div class="comment-reply"> <a id="comment_reply_video_123" data-id="123"
                                                                           data-type="video" data-reply-username="" class="" href="#"><i
                                                        class="fas fa-share"></i>Reply</a> </div>
                                        </div>
                                    </div>
                                ...
                                <div class="comment-replies">
                                    <div class="comment-reply-container d-none" id="reply_container_video_123"></div>
                                    <div class="comments-list replies-list" id="replies_more_video_123"></div>
                                    <div class="comments-list replies-list" id="replies_list_video_123"></div>
                                </div>
                            </div>
                            <div class="comment-item" id="comment_122">
                                <div class="comment-user"> <a href="../../user/demo.html"> <img
                                            src="../../media/users/18776.jpg" alt="demo"> </a> </div>
                                <div class="comment-info">
                                    <div class="comment-body">
                                        <div class="comment-actions"> <a id="comment_actions_video_122" data-uid="18776"
                                                                         data-rel="video_122" href="#" data-toggle="dropdown"
                                                                         aria-haspopup="true" aria-expanded="false"> <i
                                                    class="fas fa-ellipsis-h"></i> </a>
                                            <div class="dropdown-menu dropdown-menu-right"
                                                 aria-labelledby="comment_actions_video_122"> <a class="dropdown-item "
                                                                                                 id="report_comment_video_122" href="#"> <i class="fas fa-flag"></i>
                                                    Report Spam
                                                </a> <a class="dropdown-item d-none" id="delete_comment_video_122"
                                                        href="#"> <i class="fas fa-trash"></i> Delete
                                                </a> </div>
                                        </div>
                                        <div class="comment-user-info"> <a class="comment-username"
                                        ...
                                        <div class="comment-meta">
                                            <div class="vote-box"> <span class="content-rating"> <span
                                                        class="vote-up mr-1"><i id="comment_vote_up_video_122"
                                                                                class="fas fa-thumbs-up"></i><span
                                                            id="comment_rate_video_122">0</span></span> <span
                                                        class="vote-down"><i id="comment_vote_down_video_122"
                                                                             class="fas fa-thumbs-down"></i></span> </span> </div>
                                            <div class="comment-reply"> <a id="comment_reply_video_122" data-id="122"
                                                                           data-type="video" data-reply-username="" class="" href="#"><i
                                                        class="fas fa-share"></i>Reply</a> </div>
                                        </div>
                                    </div>
                                ...
                                <div class="comment-replies">
                                    <div class="comment-reply-container d-none" id="reply_container_video_122"></div>
                                    <div class="comments-list replies-list" id="replies_more_video_122"></div>
                                    <div class="comments-list replies-list" id="replies_list_video_122"></div>
                                    <div id="replies_show_hide_container_video_122" class="replies-show-hide-container">
                                        <a id="replies_show_more_video_122" class="replies-show-more" data-page="1"
                                           data-type="video" data-id="122" href="#">View Reply<i
                                                class="fas fa-chevron-down"></i></a> <a
                                            id="replies_show_more_video_122_"
                                            class="replies-show-more replies-view-more" data-page="1" data-type="video"
                                            data-id="122" href="#">View More <span
                                                id="replies_total_video_122_">0</span><i
                                                class="fas fa-chevron-down"></i></a> <a id="replies_hide_video_122"
                                                                                        class="replies-hide" data-type="video" data-id="122" href="#">Hide Reply<i
                                                class="fas fa-chevron-up"></i></a> <span class="reply-response"
                                                                                         id="replies_loading_video_122"></span> </div>
                                </div>
                            </div>
                            <div class="comment-item" id="comment_112">
                                <div class="comment-user"> <a href="../../user/kev.html"> <img
                                            src="../../media/users/nopic-Male.gif" alt="kev"> </a> </div>
                                <div class="comment-info">
                                    <div class="comment-body">
                                        <div class="comment-actions"> <a id="comment_actions_video_112" data-uid="29248"
                                                                         data-rel="video_112" href="#" data-toggle="dropdown"
                                                                         aria-haspopup="true" aria-expanded="false"> <i
                                                    class="fas fa-ellipsis-h"></i> </a>
                                            <div class="dropdown-menu dropdown-menu-right"
                                                 aria-labelledby="comment_actions_video_112"> <a class="dropdown-item "
                                                                                                 id="report_comment_video_112" href="#"> <i class="fas fa-flag"></i>
                                                    Report Spam
                                                </a> <a class="dropdown-item d-none" id="delete_comment_video_112"
                                                        href="#"> <i class="fas fa-trash"></i> Delete
                                                </a> </div>
                                        </div>
                                        <div class="comment-user-info"> <a class="comment-username"
                                                                           href="../../user/kev.html">kev</a> <span class="comment-add-time"><i
                                                    class="far fa-clock"></i>9 months ago</span> </div>
                                        <div class="comment-text">
                                            lo
                                        </div>
                                        <div class="comment-meta">
                                            <div class="vote-box"> <span class="content-rating"> <span
                                                        class="vote-up mr-1"><i id="comment_vote_up_video_112"
                                                                                class="fas fa-thumbs-up"></i><span
                                                            id="comment_rate_video_112">0</span></span> <span
                                                        class="vote-down"><i id="comment_vote_down_video_112"
                                                                             class="fas fa-thumbs-down"></i></span> </span> </div>
                                            <div class="comment-reply"> <a id="comment_reply_video_112" data-id="112"
                                                                           data-type="video" data-reply-username="" class="" href="#"><i
                                                        class="fas fa-share"></i>Reply</a> </div>
                                        </div>
                                    </div>
                                ...
                                <div class="comment-replies">
                                    <div class="comment-reply-container d-none" id="reply_container_video_112"></div>
                                    <div class="comments-list replies-list" id="replies_more_video_112"></div>
                                    <div class="comments-list replies-list" id="replies_list_video_112"></div>
                                </div>
                            </div>
                        </div>
