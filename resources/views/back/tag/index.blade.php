                    ...
                    <div class="row g-5 g-xl-8">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="card card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1">Add Tags</span>
...
{{--                                        </div>--}}
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                                            <!--begin::Form-->
                                            <form class="form" id="" method="post" action="{{route('tag.store')}}">
                                                @csrf
                                                <!--begin::Step 1-->
                                                <div class="current" data-kt-stepper-element="content">
                                                    <div class="w-100">
                                                        ...
                                                        <div class="fv-row mb-10">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" value="{{old('tagName')}}" class="form-control" id="validationCustom01" name="tagName" placeholder="Tag name" required>
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1">Tags List</span>
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="card-body py-3">
                                            ...
                                            <div class="table-responsive">
                                                <!--begin::Table-->
                                                <table id="table_tag" class="table  border rounded align-middle gs-0 gy-4">
                                                    <!--begin::Table head-->
                                                    <thead>
                                                    <tr class="fw-bold text-muted bg-light">
                                                        <th class="ps-4 min-w-325px rounded-start">tag Name</th>
                                                    ...
                                                    @foreach($tags as $tag)
                                                        <tr>
                                                            <td>
                                                                <div class="">
                                                                    <span class="text-dark fw-bold mb-1 mx-2">{{ $tag->tagName }}</span>
                                                                </div>
                                                            </td>

                                                            <td class="text-center">
                                                                <a href="{{ route("tag.edit", $tag) }}" class="btn btn-icon btn-bg-light btn-active-color-warning  me-1" data-toggle="tooltip" data-placement="top" title="edit">
                                                                ...
                                                                <a href="{{ route('tag.delete',$tag->id) }}" class="btn btn-icon btn-bg-light btn-active-color-danger " data-toggle="tooltip" data-placement="top" title="delete" onclick="return confirm('Do you really want to remove this line?')">
