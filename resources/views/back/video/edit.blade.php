                                    ...
                                    <div class="card-body py-3">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div class="flex-row-fluid py-lg-5 px-lg-15">
                                                <!--begin::Form-->
                                                <form class="form" id="" enctype="multipart/form-data" method="post" action="{{route('video.update',$video)}}">
                                                    @csrf
                                                    <!--begin::Step 1-->
                                                    <div class="current" data-kt-stepper-element="content">
                                                        <div class="w-100">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" value="{{ $video->videoTitle }}" class="form-control" id="validationCustom01" name="videoTitle" placeholder="video name" required>
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                    ...
                                                    <div class="current" data-kt-stepper-element="content">
                                                        <div class="w-100">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                <!--begin::Label-->
                                                                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                                                    <span class="required">video File </span>
                                                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Add video file"></i>
                                                                </label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="file" accept="video/*" value="{{ URL::asset($video->video_file) }}" class="form-control" id="" name="video_file" placeholder="video name" >
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                    ...
                                                    <div class="current" data-kt-stepper-element="content">
                                                        <div class="w-100">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="file" accept="video/*" value="{{ asset($video->trailer_file) }}" class="form-control" id="" name="trailer_file" placeholder="Trailer" >
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                    ...
                                                    <div class="current" data-kt-stepper-element="content">
                                                        <div class="w-100">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="file"  value="{{ asset($video->thumbnail_file) }}" class="form-control" id="" name="thumbnail_file" placeholder="Thumbnail" >
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                    ...
                                                    <div class="fv-row mb-10">
                                                        ...
                                                        <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select a popup group" name="tag_id" required>
                                                            @foreach($tags as $tag)
                                                                <option value="{{$tag->id}}" @if( $video->tag_id === $tag->id ) selected @endif>{{$tag->tagName}} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <!--end::Col-->
