            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">video
                        </h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                                            ...
                                            <div class="flex-row-fluid py-lg-5 px-lg-15">
                                                ...
                                                <form class="form" id="fileUploadForm" enctype="multipart/form-data" method="post" action="{{ route('video.store') }}">
                                                    ...
                                                    <!--begin::Modal - progress bar -->
                                                     <div class="modal fade" id="kt_progress_modal" tabindex="-1"
                                                        aria-hidden="true">
                                                        <!--begin::Modal dialog-->
                                                        <div class="modal-dialog mw-700px">
                                                            ...
                                                            <div class="modal-content">
                                                                <!--begin::Modal header-->
                                                                <div
                                                                    class="modal-header pb-0 border-0 d-flex justify-content-end">
                                                                    <!--begin::Close-->
                                                                                    ...
                                                                                    <div class="d-flex flex-stack">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <span id="kt_percent"
                                                                                                    class="text-gray-700 fs-6 fw-semibold me-2">100%</span>
                                                                                                <span id="kt_inprogress"
                                                                                                    class="text-muted fs-8">In
                                                                                                    progress </span>
                                                                                                <span id="kt_finished"
                                                                                                    class="text-muted fs-8">Finished
                                                                                                </span>
                                                                                                <span
                                                                                                    id="kt_video_uplaod_loder">
                                                                                                    <img src="{{ asset('assets/img/Eclipse-1s-200px.svg') }}"
                                                                                                        alt="">
                                                                                                </span>
                                                                                            </div>
                                                                                        </div>
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <label
                                                                    ...
                                                                    <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                        ...
                                                                        title="Specify unique video name"></i>
                                                                </label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" value="{{ old('videoTitle') }}"
                                                                    class="form-control" id="validationCustom01"
                                                                    name="videoTitle" placeholder="video name" required>
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <label
                                                                    ...
                                                                    <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                        data-bs-toggle="tooltip"
                                                                        title="Add video file"></i>
                                                                </label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="file" name="video_file"  value="{{ old('video_file') }}"  class="form-control" placeholder="video name" required>
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <label
                                                                    ...
                                                                    <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                        data-bs-toggle="tooltip" title="Add Trailer"></i>
                                                                </label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="file"
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <label
                                                                    ...
                                                                    <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                        data-bs-toggle="tooltip"
                                                                        title="Add thumbnail"></i>
                                                                </label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="file" value="{{ old('thumbnail') }}"
                                                                    class="form-control" id=""
                                                                    name="thumbnail_file" placeholder="Thumbnail"
                                                                    required>
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                    ...
                                                    <div class="fv-row mb-10">
                                                        ...
                                                        <select class="form-select form-select-solid"
                                                            ...
                                                            data-placeholder="Select a popup group" name="tag_id"
                                                            required>
                                                            <option value="">Select Tag...</option>
                                                            @foreach ($tags as $tag)
                                                                <option value="{{ $tag->id }}"
                                                                    @if (old('tagName') == $tag->id) selected @endif>
                                                                    {{ $tag->tagName }} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="card-body py-3">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="table_video"
                                                        class="table  border rounded align-middle gs-0 gy-4">
                                                        <!--begin::Table head-->
                                                        <thead>
                                                            ...
                                                            @foreach ($videos as $video)
                                                                <tr>
                                                                    <td>
                                                                        <div class="">
                                                                            <span
                                                                                class="text-dark fw-bold mb-1 mx-2">{{ $video->videoTitle }}</span>
                                                                        </div>
                                                                    </td>
...
@section('javascripts')
            ...
            $(document).ready(function() {
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    uploadProgress: function(event, position, total, percentComplete) {
                        $('.progress .progress-bar').css("width", parseInt(percentComplete) +
                            '%');
                        $('.progress .progress-bar').attr("aria-valuenow", parseInt(
                            percentComplete) + '%');
                    },
    ...
    {{--    progress bar end --}}
        ...
        {{-- uploda with resumable  --}} 
        <script type="text/javascript">
            let browseFile = $('#browseFile');
            let resumable = new Resumable({
                target: '{{ route('upload.large.files') }}',
